...
;; from this we produce (:ocamllex (<modulename> . <src>))
;; e.g. (:ocamllex (Pb_parsing_lexer . pb_parsing_lexer.mll))
;; :ocamllex - alist of (Foo . foo.mll) pairs
;; :ocamlyacc - alist of (Foo . foo.mly) pairs
