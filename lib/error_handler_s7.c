...
void init_error_handlers_s7(s7_scheme *s7)
{
...
EXPORT void error_config_s7(s7_scheme *s7)
{
...
EXPORT void close_error_config_s7(s7_scheme *s7) // s7_pointer err_port)
{
