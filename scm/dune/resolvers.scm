                                                      ...
                                                      (if (list? (cdr ml-static))
                                                          (let* ((mibl-trace-let "ml-static" ml-static)
                                                                 ...
                                                                 (fixed (filter (lambda (dep)
                                                                                  (mibl-trace "ml-static dep" dep)
                                                                                  (not (eq? :unresolved (car dep))))
                                                                                deps)))
                                                            ;; (format #t "XXXX fixed: ~A~%" fixed)
                                                            ;; (format #t "XXXX ml-static: ~A~%" ml-static)
                                                            (if (truthy? fixed)
                                                    ...
                                                    (if (list? (cdr struct))
                                                        (let* ((deps (cddr struct))
                                                               (resolved (filter (lambda (dep)
                                                                                   (mibl-trace "struct-static dep" dep)
                                                                                   (not (eq? :unresolved (car dep))))
                                                                                 deps)))
                                                          (if (truthy? resolved)
